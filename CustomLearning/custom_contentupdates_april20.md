...
---
# <a name="microsoft-365-learning-pathways-content-updates-for-april"></a>Microsoft 365 Mises à jour du contenu du parcours d’apprentissage pour avril
Les parcours d’apprentissage s’efforcent d’adhérer à un cycle de mise à jour de contenu trimestrielle. La liste suivante liste les mises à jour de contenu pour avril 2020.

## <a name="april-2020-content-updates"></a>Mises à jour de contenu d’avril 2020
 En réponse aux événements actuels, la mise à jour du contenu d’avril 2020 fournit des playlists d’apprentissage et des ressources conçues pour permettre le travail à distance dans votre organisation. Nous avons ajouté un nouvel ensemble de playlists De travail à distance, mis à jour considérablement le contenu Microsoft Teams, en particulier pour les réunions Teams, ajouté un nouvel ensemble de playlists Office sur le Web et ajouté de nouvelles ressources Microsoft Forms. Dans le cadre de la mise à jour, nous avons également fourni une liste de ressources de travail à distance pour les administrateurs.  
 
 Pour en savoir plus sur l’application des mises à jour de contenu et la gestion des mises à jour de contenu, voir Gérer les mises [à jour de contenu.](custom_contentupdatesmanage.md) La liste suivante répertorie les mises à jour de contenu du Microsoft 365 parcours d’apprentissage d’avril 2020. 

### <a name="office-365-was-rebranded-to-microsoft-365"></a>Office 365 a été renommé Microsoft 365
Office 365 a été renommé en Microsoft 365. Le changement de nom est reflété dans le contenu du Microsoft 365 parcours d’apprentissage. 
...
- Travailler à distance avec les Office 365
...
Diverses mises à jour ont été mises à jour Teams contenu. 
#### <a name="collaborate-in-teams-and-channels-1-new1-updated-asset"></a>Collaborer dans des équipes et des canaux (1 nouveauté/1 mise à jour)
- Créer et utiliser des canaux privés (nouveau)
- Afficher ou masquer les canaux (mis à jour)
#### <a name="start-chats-and-calls-2-new1-updated"></a>Démarrer des conversations et des appels (mise à jour 2/1)
...
- Participer à une Teams réunion (nouvelle)
...
- Afficher PowerPoint diapositives (mise à jour)
- Se déplacer pendant une Teams réunion (mise à jour)
#### <a name="work-with-post-and-messages-1-new"></a>Travailler avec des billets et des messages (1 nouveau)
- Publier un message sur plusieurs canaux (nouveau)

### <a name="office-for-the-web"></a>Office pour le web
Office sur le Web propose un ensemble de playlists pour les scénarios dans lequel les utilisateurs souhaitent créer, partager et collaborer avec Office sur le Web. Cet ensemble de contenu est également utile pour les organisations qui passent de Google G Suite à Microsoft 365.
#### <a name="get-started-5-new-assets"></a>Mise en place (5 nouvelles ressources)
- Prise en main
...
- Se faire connaître Outlook web
...
- [Prise en charge des travailleurs à distance à l’aide Microsoft Teams](/microsoftteams/support-remote-work-with-teams)
...
- [Microsoft Teams Formation](/microsoftteams/training-microsoft-teams-landing-page)
