...
Microsoft utilise les pages GitHub comme source de réseau de distribution de contenu (CDN) pour ses fichiers manifeste et ses images. Nous avons un dossier de documents à la racine de notre référentiel GitHub qui inclut des sous-dossiers pour chaque version des fichiers manifeste. À l’intérieur de chaque dossier se trouve trois fichiers manifeste, ainsi qu’un dossier d’images pour stocker toutes les images de catégorie, de sous-catégorie et de playlist. 
...
7. Dans la **zone Sélectionner la source** d’apprentissage, sélectionnez votre pack de contenu personnalisé, puis filtrez le contenu en sélectionnant le contenu de votre choix. L’exemple suivant illustre le filtre de la sélection du web à partir d’un pack de contenu personnalisé.
